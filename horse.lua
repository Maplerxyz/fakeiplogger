...
local Window = library:AddWindow("Horse Valley | GARFIELDWAREZ", {
	main_color = Color3.fromRGB(216, 152, 0),
	min_size = Vector2.new(400, 300),
	toggle_key = Enum.KeyCode.RightShift,
	can_resize = true,
})
...
Main:AddSwitch("Autofarm Stars Expect For Strength",function(t)
	Thingies.AutofarmActive = t 
	print(Thingies.AutofarmActive)
end)
 
Main:AddSwitch("Autofarm Strength Stars (Slow)",function(t)
	Thingies.autofarmstrength = t 
	print(Thingies.AutofarmActive)
end)
 
Main:AddSwitch("Always Horse Sprint",function(t)
	Thingies.alwayssprint = t 
end)
...
spawn(function()
	while true do wait(0.0001)
		pcall(function()
			if Thingies.AutofarmActive == true then 
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Training["Round Pens"]["Round Pen"].Triggers.Trigger.CFrame
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Training["Round Pens"]["Round Pen"].Stars[game.Players.LocalPlayer.Name].CFrame * CFrame.new(0,-2,0)
				wait(0.2)
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Training["Pole Bending"].Triggers.Trigger.CFrame 
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Training["Pole Bending"].Stars[game.Players.LocalPlayer.Name].CFrame * CFrame.new(0,-2,0)
				wait(0.2)					
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Training["Barrel Racing"].Triggers.Trigger.CFrame
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Training["Barrel Racing"].Stars[game.Players.LocalPlayer.Name].CFrame * CFrame.new(0,-2,0)
				wait(0.2)
 
			end
 
			if Thingies.alwayssprint == true then 
 
				local ohNumber1 = 4
 
				game:GetService("ReplicatedStorage").Signals.HorseGait:FireServer(ohNumber1)
			end
 
			if Thingies.autofarmstrength == true then 
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Training.Jumping.Triggers.Trigger.CFrame 
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Training.Jumping.Stars[game.Players.LocalPlayer.Name].CFrame 
				wait(0.2)
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Training["Round Pens"]["Round Pen"].Triggers.Trigger.CFrame
				wait(0.2)
			end
...
Main:AddButton("Remove Damage from Hurdles",function()
	pcall(function()
		for i,v in pairs(game:GetService("Workspace").Training.Jumping.Obstacles:GetDescendants()) do 
...
Main:AddLabel("Enable 'Always Horse Sprint' and remove hurdle damage")
Main:AddLabel("for strength autofarm")
Main:AddLabel("STRENGTH AND OTHER AUTOFARM CANNOT BE ON AT")
Main:AddLabel("SAME TIME")
Main:AddLabel("strenth autofarm drains energy")
Main:Show()
